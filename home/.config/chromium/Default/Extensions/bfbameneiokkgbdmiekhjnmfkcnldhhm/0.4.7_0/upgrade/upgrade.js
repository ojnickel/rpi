...
{
  chrome.tabs.create({ url: "http://chrispederick.com/work/web-developer/chrome/installed/" + version + "/" });
};
...
WebDeveloper.Upgrade.upgrade = function()
{
  ...
  if(previousVersion != "0.4.7")
  {
    WebDeveloper.Storage.setItem("version", "0.4.7");
    WebDeveloper.Upgrade.openUpgradeURL("0.4.7");
