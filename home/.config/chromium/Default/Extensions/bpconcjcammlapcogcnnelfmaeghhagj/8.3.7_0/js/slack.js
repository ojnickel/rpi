            ...
            $channel.append(
                $('<li>').append(
                        ...
                        $('<span>').attr({
                            ...
                            'title':   chrome.i18n.getMessage("tooltipClickToUploadTo") + ' ' +  data.channels[chanlen].name,
                            'data-id': data.channels[chanlen].id
                        }).on('click', function (e) {
        ...
        for (var uselen = data.users.length; uselen--;) {
            $user.append(
                $('<li>').append(
                        ...
                        $('<span>').attr({
                            'class':   'nsc-icon nsc-fast-send',
                            'title':   chrome.i18n.getMessage("tooltipClickToUploadTo") + ' ' + data.users[uselen].name,
                            'data-id': data.users[uselen].id
                        }).on('click', function (e) {
                            $('#nsc_send').data('channel', $(this).data('id')).trigger('click');
                        })
