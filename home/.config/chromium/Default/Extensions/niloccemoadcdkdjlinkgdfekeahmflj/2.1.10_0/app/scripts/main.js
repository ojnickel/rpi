...
(function(PKT_EXT){
    ...
    var showStateSaved  = function(urlToSave, itemID, features) {
        PKT_EXT.ERROR.closeError()
        PKT_EXT.SAVE.saveURL( urlToSave, itemID, features )
    }
    ...
    var handleMessageResponse = function(request) {
        ...
        switch(request.status){
            ...
            case 'success':
                showStateSaved(request.features.url, request.item_id, request.features)
                break
